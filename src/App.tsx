  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        >
          Perfekte Nägel, <br /> <span className="italic">perfekter Look.</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Nageldesign, Maniküre, Pediküre und Wimpernverlängerung. {config.business.yearsExperience} Jahre Erfahrung im Herzen von Heilbronn.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="absolute bottom-12 left-6 md:left-12 z-10 hidden md:block">
        <div className="flex items-center gap-4 text-white/60 text-[10px] uppercase tracking-widest">
          <div className="flex items-center gap-2">
            <ShieldCheck size={14} className="text-primary" aria-hidden="true" /> Mit oder ohne Termin
          </div>
    ...
    <section id="services" className="py-32 px-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
        <div className="max-w-2xl">
          ...
          <h2 className="font-serif text-5xl md:text-7xl leading-tight">Nagelpflege auf <br /> <span className="italic">höchstem Niveau.</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <h2 className="font-serif text-5xl md:text-6xl mb-8">Willkommen bei <br /><span className="italic">{config.owner.name}.</span></h2>
            </div>
